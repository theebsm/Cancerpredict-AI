...
with st.expander("📊 Model Performance Dashboard", expanded=False):
    ...
    with c1:
        ...
        ax.set_title("Model Accuracy", color="white", fontweight="bold")
    ...
    ax.set_title("Feature Importance", color="white", fontsize=12, fontweight="bold")
    ax.tick_params(colors="white")
    for spine in ["top","right"]: ax.spines[spine].set_visible(False)
    for spine in ["bottom","left"]: ax.spines[spine].set_color("white")
    st.pyplot(fig); plt.close()
    ...
    if mol is None:
        ...
        with col2:
            ...
            with tab1:
                ...
                ax.set_title(f"Model Predictions", color="white", fontsize=12, fontweight="bold")
                ax.tick_params(colors="white")
            ...
            with tab2:
                ...
                ax.set_ylim(0,1.5); ax.set_title("Toxicity Flags", color="white", fontsize=12, fontweight="bold")
                ax.tick_params(colors="white")
                for spine in ["top","right"]: ax.spines[spine].set_visible(False)
                for spine in ["bottom","left"]: ax.spines[spine].set_color("white")
                st.pyplot(fig); plt.close()
            ...
            with tab3:
                ...
                ax.set_yticklabels([])
                ax.set_title("Molecular Profile", color="white", fontsize=12, fontweight="bold", pad=20)
            ...
            with tab4:
                ...
                ax.set_title("Target Similarity", color="white", fontsize=12, fontweight="bold"); ax.tick_params(colors="white")
                for spine in ["top","right"]: ax.spines[spine].set_visible(False)
                for spine in ["bottom","left"]: ax.spines[spine].set_color("white")
                st.pyplot(fig); plt.close()
            ...
            with tab6:
                ...
                with c1:
                    ...
                    ax.set_title("Molecular Properties", color="white", fontsize=12, fontweight="bold")
                ...
                with c2:
                    ...
                    ax.set_title("Drug Repurposing", color="white", fontsize=12, fontweight="bold")
                    ax.tick_params(colors="white", labelsize=7)
                    for spine in ["top","right"]: ax.spines[spine].set_visible(False)
                    for spine in ["bottom","left"]: ax.spines[spine].set_color("white")
                    st.pyplot(fig); plt.close()
